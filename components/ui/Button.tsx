...
export const Button: React.FC<ButtonProps> = ({ children, className, variant = 'primary', type = 'button', ...props }) => {
  ...
  const variantClasses = {
    primary: 'text-white bg-primary hover:bg-primary-hover focus:ring-primary hover:shadow-glow-primary transform hover:scale-105 active:scale-95',
    secondary: 'text-text-primary bg-surface hover:bg-background border-border focus:ring-primary transform hover:scale-102 active:scale-98'
  };
