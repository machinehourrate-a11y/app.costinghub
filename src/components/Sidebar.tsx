...
const Icons = {
    ...
    Documentation: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
}
  ...
  return (
    <aside className="bg-surface text-text-primary flex flex-col p-3 shadow-lg border-r border-border transition-all duration-300 w-64 h-full">
        ...
        <nav className="flex-1 space-y-2 overflow-y-auto">
            ...
            <div className="pt-2 border-t border-border/50 my-2"></div>
            <NavItem label="User Guide" view="documentation" icon={Icons.Documentation} {...{ currentView, onNavigate }} />
        </nav>
        ...
        <div className="mt-auto pt-2 border-t border-border/50 space-y-2">
            ...
            <div className="mx-2 mb-2 p-4 bg-background/50 rounded-xl border border-border shadow-sm">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wide ${isSuperAdmin ? 'bg-purple-100 text-purple-800' : 'bg-primary/10 text-primary'}`}>
                    {isSuperAdmin ? 'Admin' : (user.plan_name || 'Free')}
                </span>
              </div>
