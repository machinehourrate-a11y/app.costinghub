...
export interface UserFeatures {
    ...
    can_use_cnc_costing: boolean;
    can_use_should_costing: boolean;
...
export interface CalculatorPageProps {
  ...
  processes: Process[];
  tools: Tool[];
  countryCosts: RegionCost[];
  countryCurrencyMap: RegionCurrencyMap[];
...
export interface CostMasterPageProps {
  ...
  onAddCountryCurrency: (map: { country: string, currency: string }) => Promise<void>;
  onDeleteCountryCurrency: (id: string) => Promise<void>;
}
